...
export declare const parseAndCheckHttpResponse: (
  operations: any,
) => (response: Response) => Promise<any>;
export declare const checkFetcher: (
...
export declare const selectHttpOptionsAndBody: (
  operation: Operation,
...
export declare const selectURI: (
  operation: any,
